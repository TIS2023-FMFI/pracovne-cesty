<div>
    <img style="width: 100%; height: 189px; left: 0; top: 0" src="https://via.placeholder.com/1512x189" />
    ...
    <div style="width: 31px; height: 23px; left: 1338px; top: 13px; position: absolute">
        {{ $slot }}
    </div>
</div>
